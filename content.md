...
- Logo + Navigation
- Hero
- Featured in (this section is usually in the hero section or right after it)
- How it works (more important than features)
- Meals (and list of diets)
- Testimonials + Gallery
- Pricing + Features (most of the time it is at the bottom of the page and right before the CTA)
- Call to action (CTA) (most of the time it is at the bottom of the page and right before the footer)
- Footer
